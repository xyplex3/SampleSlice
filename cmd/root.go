...
func init() {
	...
	rootCmd.Flags().Bool("krz-compress", false, "Reserved for future ADPCM compression support; currently has no effect on KRZ output (default: false)")
	rootCmd.Flags().String("voice-mode", "drum", "Reserved for future KRZ voice-mode support (drum or poly); currently has no effect on KRZ output (default: drum)")
	rootCmd.Flags().Uint("priority", 0, "Reserved for future KRZ voice-priority support (1-8); currently has no effect on KRZ output (default: 7 for drum, 3 for poly)")
	rootCmd.Flags().Bool("stereo", false, "Reserved for future KRZ stereo voice-mode support; currently has no effect on KRZ output (default: false)")
